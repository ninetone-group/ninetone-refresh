/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3109cb0ce4b004f458ccc9101fe385a8)
// Runtime types generated with workerd@1.20260908.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	CACHE_STATE: KVNamespace;
	SESSION: KVNamespace;
	CONTACT_SUBMISSIONS: KVNamespace;
	PUBLICATION_STATE: KVNamespace;
	PUBLICATION_RELEASES: KVNamespace;
	CONTACT_EMAIL: SendEmail;
	TRANSLATION_JOBS: Queue;
	...
	SHOPIFY_PUBLIC_STORE_URL: string;
	SHOPIFY_ADMIN_TOKEN: string;
	SHOPIFY_HOMEPAGE_COLLECTION_ID: string;
	PUBLISH_PASSWORD: string;
	PUBLICATION_COORDINATOR: DurableObjectNamespace<import("./src/worker-entry").NinetonePublicationCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker-entry");
		durableNamespaces: "NinetonePublicationCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FM_HOST" | "FM_DB" | "FM_USER" | "FM_PASS" | "SHOPIFY_SHOP_DOMAIN" | "SHOPIFY_PUBLIC_STORE_URL" | "SHOPIFY_ADMIN_TOKEN" | "SHOPIFY_HOMEPAGE_COLLECTION_ID" | "PUBLISH_PASSWORD">> {}
}
